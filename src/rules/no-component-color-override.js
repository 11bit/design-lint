/**
 * no-component-color-override — stub.
 *
 * The specification is `docs/rules/no-component-color-override.md`, whose `caught` / `allowed` /
...
export default {
  meta: {
    ...
    docs: { description: "See docs/rules/no-component-color-override.md" },
    messages: {},
  },
  create() {
    return {};
